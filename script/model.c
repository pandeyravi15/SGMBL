...
int main(int argc, char *argv[])
{
	...
	char *genome=malloc(200000000*sizeof(char)),opf_extn[]=".param.txt",opf_extn1[]=".clustering1.txt",opf_extn2[]=".clustering2.txt";
...
/*#################################################################Transitional Probablities##########################################################################################*/
 	//rindex=5;
       if(i0>1048576){rindex=8;}
	if((i0>262144)&&(i0<1048576)){rindex=7;}
 	if((i0>65536)&&(i0<261244)){rindex=6;}
 	if((i0>16384)&&(i0<65536)){rindex=5;}
 	if((i0>4096)&&(i0<16384)){rindex=4;}
	if((i0>1024)&&(i0<4096)){rindex=3;}
	if((i0>100)&&(i0<1024)){rindex=2;}
	if((i0>16)&&(i0<100)){rindex=1;}

	sprintf(opfile,"%s.%d%s",argv[1],rindex,opf_extn);
